...
if not st.session_state["signedout"]:
    ...
    if choice == 'Sign up':
        st.sidebar.info('Make a password of at least 6 characters to be considered safe.')
        username = st.sidebar.text_input('Please input your unique username', value='Default')
