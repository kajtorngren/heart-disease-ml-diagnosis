    ...
    if login:
        try:
            ...
            if st.button('Predict User Input'):
                ...
                if prediction[0] == 0:
                    st.text(f":red-background[The model predicts that the patient is at risk of heart disease with a probability of {prediction_proba[0][0]*100:.1f}%.]")
                else:
                ...
                if 'Data' in data:
                    ...
                    for entry in reversed(data['Data']):
                        ...
                        row = {
                            ...
                            'Total prediction': entry.get('TotalPrediction', ['No prediction'])[0]
                        }
